...
const CarChargerEventLog = ({ eventData, setEndDate, setStartDate }) => {
  ...
  return (
    <Card style={{ height: "auto", width: "800px", margin: "auto" }}>
      <CardContent
        style={{
          display: "flex",
      ...
      >
        ...
        <TableContainer style={{ margin: "2vh", width: "100%", maxHeight: "200px" }}>
          <Table>
            <TableHead>
              <TableRow>
...
export default CarChargerEventLog;
